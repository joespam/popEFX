...
function ColorFinder(colorFactorCallback) {
  ...
  this.setCallback = function(callbackFn) {
...
(function() {
  $(function() {
    return $('#pictures').imagesLoaded(function() {
  ...
  $(function() {
    return $('#picGallery').imagesLoaded(function() {
      return $('#picGallery').masonry({
...
(function() {
  $(function() {
    return $('#signupGal').imagesLoaded(function() {
      var $gallery;
      $gallery = $('#signupGal');
